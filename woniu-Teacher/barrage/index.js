let data = [
    ...
    { value: '周杰伦的听妈妈的话', time: 10, color: 'red', speed: 1, fontSize: 18 },
    { value: '周杰伦大哥', time: 20, color: 'blue', speed: 1, fontSize: 35 }
]
...
class CanvasBarrage {
    ...
    randerBarrage() {
        //根据视屏播放的时间和弹幕展示的时间作比较，来判断是否要展示弹幕
