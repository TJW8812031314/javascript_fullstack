  ...
  <div class="contaner">
    ...
    <div class="feature">
      <div class="group" v-if="futureTem && futureTem[1]">
        ...
        <span class="tm">夜间:{{futureTem[1].nightTemp}} {{futureTem[1].nightWeather}} {{futureTem[1].nightWind}} {{futureTem[1].nightWindPower}}</span>
      </div>
      <div class="group" v-if="futureTem && futureTem[2]">
        ...
        <span class="tm">夜间:{{futureTem[2].nightTemp}} {{futureTem[2].nightWeather}} {{futureTem[2].nightWind}} {{futureTem[2].nightWindPower}}</span>
      </div>
    </div>
...
.loader .face:nth-child(2){
  ...
  height: 70%;
  color: lime;
  border-width: 0.2em 0.2em 0em 0.2em;
  /* currentColor 继承颜色 */
